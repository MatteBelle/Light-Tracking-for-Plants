...
#     logs_folder = "python_project/logs"
#     scripts = ['data_proxy_MQTT', 'data_proxy_HTTP']
#     scripts_extension = '.py'
#     scripts_folder = "python_project/data_proxy/"
#     processes = []
...
#             with open(f"{logs_folder}/{script}.log", "w") as log_file:
#                 process = subprocess.Popen(['python', scripts_folder+script+scripts_extension], stdout=log_file, stderr=subprocess.STDOUT)
#                 #process = subprocess.Popen(['python', scripts_folder+script+scripts_extension], stderr=subprocess.STDOUT)
#                 processes.append(process)
